...
## Project Structure
    ...
    ├── which_suites_you_29578  # Django project configurations
...
1. Clone this repo and `cd which_suites_you_29578`
...
2. Clone this repo and `cd which_suites_you_29578`
